...
#define WIFI_SSID "Kha's Home"
#define WIFI_PASSWORD "08052001"

// Insert Firebase project API Key
#define API_KEY "AIzaSyDxzVMo2e9JXvUm7WXdn1asmW9Gs_Tzct0"

// Insert RTDB URLefine the RTDB URL */
#define DATABASE_URL "https://esp32-cam-b1f5b-default-rtdb.asia-southeast1.firebasedatabase.app/"
...
// Initialize function for wifi connection and firebase connection
void initWifi() {
  Serial.begin(115200);
...
void writePayloadToFirebase(const struct quirc_data *data) {
...
// getEpochTime() Function that gets current epoch time
